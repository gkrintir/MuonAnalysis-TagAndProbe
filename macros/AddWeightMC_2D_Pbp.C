...
void AddWeightMC_2D_Pbp() {

  //input files

  //Pbp
  TFile *inputData = TFile::Open("/eos/cms/store/group/phys_heavyions/okukral/TagAndProbe2016/LowPt/tnpJPsi_Data_Pbp-merged.root");
  //TFile *inputMC   = TFile::Open("tnpJPsi_MC_Pbp_noWeight.root","update");
  TFile *inputMC   = TFile::Open("tnpJPsi_MC_Pbp-Skimmed.root","update");
  ...
  cout << "avgVal (should be close to 1) = " << avgVal << endl;
