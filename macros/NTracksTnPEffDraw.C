...
const double effmin = 0.9;
const double sfrange = 0.03;
const char* fDataName[nSyst] = { "../test/zmumuHI/TrackingResults/tnp_Ana_Data_RecoTracking_pPb+Pbp.root" };
const char* fMCName[nSyst] = { "../test/zmumuHI/TrackingResults/tnp_Ana_MC_RecoTracking_pPb+Pbp.root" };
#endif
