...
double tnp_weight_trkM_eta(double eta, int idx = 0); //not needed now
double tnp_weight_muid_ppb(double pt, double eta, int idx = 0);
double tnp_weight_muid_nTrack(int nTrack, int idx = 0); ////not needed now
