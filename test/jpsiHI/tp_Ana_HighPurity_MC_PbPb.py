...
VEFFICIENCYSET =cms.VPSet(
    cms.PSet(
        HP_1bin = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HighPurity","true"),
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_Ana_MC_PbPb_HighPurity_%s_%s.root" % (PDFName,scenario)),
