...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("file:tnp_fitOutput_MuonIDTrigger_fromTrkMuon_TightAcceptance_data_pp_pol1.root"),
    ...
    PDFs = cms.PSet(
        ...
        CBGPlusPol1 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.02,3.15], sigma1[0.025, 0.014, 0.07], alpha[2.1, 0.2, 50.0], n[3.0, 1.2, 50.])",
     ...
     Efficiencies = cms.PSet(
        ...
        MuIdTrg_abseta00_12 = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
                ...
                pt = cms.vdouble(3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 6, 6.5, 7, 7.5, 8, 9, 10.5, 12.25, 14, 16, 18, 23, 30),   
         ...
         MuIdTrg_abseta12_18 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(2.06, 2.3, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.5, 5, 5.75, 6.5, 7.5, 8.5, 9.5, 10.5, 12, 14, 17, 22, 30),
         ...
         MuIdTrg_abseta18_21 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(1.5, 1.7, 1.9, 2.2, 2.5, 2.8, 3.1, 3.5, 4, 4.5, 5, 6, 7, 8.5, 10, 13, 19, 30),
         ...
         MuIdTrg_abseta21_24 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 #pt = cms.vdouble(1.5, 1.85, 2.2, 2.5, 3, 3.5, 4, 4.5, 5, 6.5, 8.5, 11, 14, 30),
                 pt = cms.vdouble(1.5, 1.7, 1.9, 2.2, 2.5, 2.8, 3.1, 3.5, 4, 4.5, 5.5, 6.5, 8, 10.5, 15, 30),
