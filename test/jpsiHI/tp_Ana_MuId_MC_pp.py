...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_fitOutput_HybridSoftID_MC_pp_CBGPlusPol1_narrowMrange.root"),#file:/afs/cern.ch/work/v/vabdulla/private/TnP/MuId/tnp_Ana_MuonID_RD_pp_16022017_pol1.root"),
    ...
    PDFs = cms.PSet(
        ...
        CBGPlusPol2 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.05,3.15], sigma1[0.025, 0.014, 0.07], alpha[2.1, 0.9, 50.0], n[3.0, 2., 50.])",
    ...
    Efficiencies = cms.PSet(
        MuId_1bin = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HybridSoftId_2018","true","passedDXY_SOFT","true","passedDZ_SOFT","true","TM","true"),
        ...
        MuId_abseta00_12 = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
                ...
                pt = cms.vdouble(3.3, 3.7, 4, 4.5, 5, 5.5, 6, 7, 8, 10.5, 14, 18, 30),
         ...
         MuId_abseta12_18 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(1.75, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 9, 14, 18, 30),
         ...
         MuId_abseta18_21 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(1.33, 1.75, 2.1, 2.5, 3, 3.5, 4, 4.5, 5.25, 6.5, 9, 13, 30),
         ...
         MuId_abseta21_24 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                 ...
                 pt = cms.vdouble(1.2, 1.9, 2.5, 3, 3.5, 4, 4.75, 5.5, 8., 12, 30),
         ...
         MuId_absetadep_HighPt = cms.PSet(
             EfficiencyCategoryAndState = cms.vstring("HybridSoftId_2018","true","passedDXY_SOFT","true","passedDZ_SOFT","true","TM","true"),
             UnbinnedVariables = cms.vstring("mass"),
             BinnedVariables = cms.PSet(
                 pt = cms.vdouble(3, 30),
