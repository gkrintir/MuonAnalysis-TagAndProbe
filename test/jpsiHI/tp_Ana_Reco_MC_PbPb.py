   ...
   cms.PSet(
      Trk_1bin = cms.PSet(
         ...
         BinnedVariables = cms.PSet(
            ...
            outerValidHits = cms.vstring("true"),
            ),
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_Ana_MC_PbPb_Reco_%s_%s.root" % (PDFName, scenario)),
    ...
    Cuts = cms.PSet(
       ...
       dr0_cut = cms.vstring("track deltaR matching", "tk0_deltaR", "0.3"),
       deta0_cut = cms.vstring("track deltaEta matching", "tk0_deltaEta", "0.3"),
    ),
