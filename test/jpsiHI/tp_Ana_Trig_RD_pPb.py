...
# Order: 0 total, 1 pT, 2-8 pT fits in abseta bins, 9 abseta, 10 eta, 11 ntracks, 12-14 pt fits in 3 ntracks bins, 15-17 eta fits in 3 ntracks bins, 18 nvertices   NOTE: IS NOT SAME AS SCENARIO
    ...
    cms.PSet(
       Trig_pt = cms.PSet(
           ...
           UnbinnedVariables = cms.vstring("mass"),
           BinnedVariables = cms.PSet(
		pt = cms.vdouble(1.3, 1.8, 2.5, 3.5, 4.5, 5.5, 6.5, 8.0, 10.5, 14.0, 18.0, 25.0),
		eta = cms.vdouble(-2.4,2.4),
		tag_nVertices    = cms.vdouble(0.9,1.1),
		#TM = cms.vstring("true"),
		#isNotMuonSeeded = cms.vstring("true"),
    ...
    cms.PSet(
        Trig_abseta00_09 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
		pt = cms.vdouble(3.3, 3.8, 4.5, 5.5, 6.5, 8.0, 10.5, 14.0, 18.0, 25.0),
    ...
    cms.PSet(
         Trig_abseta12_16 = cms.PSet(
             ...
             UnbinnedVariables = cms.vstring("mass"),
             BinnedVariables = cms.PSet(
		pt = cms.vdouble(2.2, 3.0, 4.5, 6.5, 10.0, 14.0, 25.0),
    ...
    cms.PSet(         
         Trig_abseta16_21 = cms.PSet(
             ...
             UnbinnedVariables = cms.vstring("mass"),
             BinnedVariables = cms.PSet(
		pt = cms.vdouble(1.6, 2.2, 3.0, 4.5, 6.5, 10.0, 14.0, 25.0),
    ...
    cms.PSet(
        Trig_abseta21_24 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
		pt = cms.vdouble(1.3, 2.2, 3.5, 5.5, 8.0, 12.0, 25.0),
    ...
    cms.PSet(
        Trig_ntracks00_30_ptdep = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HLT_PAL1DoubleMuOpen","true"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
                pt = cms.vdouble(1.3, 1.8, 2.5, 3.5, 4.5, 5.5, 6.5, 8.0, 10.5, 14.0, 18.0, 25.0),
    ...
    cms.PSet(
        Trig_ntracks30_75_ptdep = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HLT_PAL1DoubleMuOpen","true"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
                pt = cms.vdouble(1.3, 1.8, 2.5, 3.5, 4.5, 5.5, 6.5, 8.0, 10.5, 14.0, 18.0, 25.0),
    ...
    cms.PSet(
        Trig_ntracks75_400_ptdep = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HLT_PAL1DoubleMuOpen","true"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
                pt = cms.vdouble(1.3, 1.8, 2.5, 3.5, 4.5, 5.5, 6.5, 8.0, 10.5, 14.0, 18.0, 25.0),
    ...
    cms.PSet(
        Trig_ntracks00_30_etadep = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HLT_PAL1DoubleMuOpen","true"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
		pt = cms.vdouble(1.3 ,25.0),
    ...
    cms.PSet(
        Trig_ntracks30_75_etadep = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HLT_PAL1DoubleMuOpen","true"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
                pt = cms.vdouble(1.3 ,25.0),
    ...
    cms.PSet(
        Trig_ntracks75_400_etadep = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("HLT_PAL1DoubleMuOpen","true"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
                pt = cms.vdouble(1.3 ,25.0),
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    # pPb:
    #InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/okukral/TagAndProbe2016/LowPt/tnpJPsi_Data_pPb-mergedMuId.root"),
    # Pbp:
    #InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/okukral/TagAndProbe2016/LowPt/tnpJPsi_Data_Pbp-mergedMuId.root"),
    ####
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_RD_Trig_pPb_%s.root" % (scenario)), #Dont forget to change output name when changing inputs
