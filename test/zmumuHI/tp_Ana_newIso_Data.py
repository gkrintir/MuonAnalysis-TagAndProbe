...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("file:datanew.root"),
   # InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/MC_trees_pPb.root"),
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_Data_newIso_vpv_tkiso2p5_dxyz_ptGT7_M60120.root"),
    ...
    Categories = cms.PSet(
                        ...
                        tkiso2p5 = cms.vstring("tkiso2p5", "dummy[true=1,false=0]"),
    ...
    Efficiencies = cms.PSet(
          ...
          cms.PSet(
             Iso_1bin = cms.PSet(
                EfficiencyCategoryAndState = cms.vstring("tkiso2p5","true","dxycut","true","dzcut","true"),
          ...
          cms.PSet(
             Iso_pt = cms.PSet(
                ...
                UnbinnedVariables = cms.vstring("mass"),
                BinnedVariables = cms.PSet(
                   pt = cms.vdouble(7, 15, 30, 40, 50, 60, 70, 80, 100, 200),
                   eta = cms.vdouble(-2.4,2.4),
                   #tag_nVertices    = cms.vdouble(0.9,1.1),
                   TightId = cms.vstring("true"),
                   #hltL3fL1sSingleMu7BptxANDL1f0L2f0L3Filtered12 = cms.vstring("true"),
          ...
          cms.PSet(
             Iso_abseta00_12 = cms.PSet(
                ...
                UnbinnedVariables = cms.vstring("mass"),
                BinnedVariables = cms.PSet(
                   pt = cms.vdouble(7, 15, 25, 30, 35, 40, 45,50, 80, 200),
          ...
          cms.PSet(
                Iso_abseta21_24 = cms.PSet(
                   ...
                   UnbinnedVariables = cms.vstring("mass"),
                   BinnedVariables = cms.PSet(
                      pt = cms.vdouble(7, 15, 25, 40, 80, 200),
