...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("file:datanew2.root"),
   # InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/MC_trees_pPb.root"),
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_Data_newIso_vpv_iso0p15_dxyz_ptGT7_M60120.root"),
    ...
    Efficiencies = cms.PSet(
          ...
          cms.PSet(
                Iso_abseta21_24 = cms.PSet(
                   ...
                   UnbinnedVariables = cms.vstring("mass"),
                   BinnedVariables = cms.PSet(
                      pt = cms.vdouble(7, 12, 15, 25, 40, 80, 200),
