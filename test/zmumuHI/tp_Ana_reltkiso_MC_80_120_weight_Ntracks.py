...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
   ...
   # InputFileNames = cms.vstring("file:/afs/cern.ch/work/o/okukral/TnP_pPb/Data/MC_trees_pPb.root"),
    ...
    OutputFileName = cms.string("tnp_Ana_MC_reltkiso0p2_ptGT7_M80120_weight_Ntracks_20190820.root"),
    ...
    WeightVariable = cms.string("weight_Ntracks"),
    
    # defines all the real variables of the probes available in the input tree and intended for use in the efficiencies
    Variables = cms.PSet(
                         mass             = cms.vstring("Tag-Probe Mass", "80.0", "120.0", "GeV/c^{2}"), # mass range syst: 65-110, nom 60-120 - TBA
                         ...
                         weight_Ntracks   = cms.vstring("weight_Ntracks","0","10",""),
    ),
    ...
    Efficiencies = cms.PSet(
          ...
          cms.PSet(
             Iso_1bin = cms.PSet(
                ...
                UnbinnedVariables = cms.vstring("mass", "weight_Ntracks"),
          ...
          cms.PSet(
             Iso_pt = cms.PSet(
                ...
                UnbinnedVariables = cms.vstring("mass", "weight_Ntracks"),
                BinnedVariables = cms.PSet(
                   pt = cms.vdouble(10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 100, 200),
                   eta = cms.vdouble(-2.4,2.4),
                   #tag_nVertices    = cms.vdouble(0.9,1.1),
                   TightId = cms.vstring("true"),
                   # hltL3fL1sSingleMu7BptxANDL1f0L2f0L3Filtered12 = cms.vstring("true"),
